...
const PanelContent = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      const { prefixCls, isActive, style, role, className, classNames: customizeizeClassNames, styles } = props
      return (
        <div
        ...
        >
          <div
            class={classnames(`${prefixCls}-content-box`, customizeizeClassNames?.body)}
            style={styles?.body}
          >
            {slots.default?.()}
          </div>
